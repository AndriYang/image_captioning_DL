...
def train(data_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch, train_encoder):
    decoder.train()
    encoder.train()
    # Train the models
...
#     decoder = DecoderRNN(args.embed_size, args.hidden_size, len(vocab), args.num_layers).to(device)
    ...
    for epoch in range(1, args.num_epochs+1):
        ...
        train_loss = train(data_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch, train_encoder)
